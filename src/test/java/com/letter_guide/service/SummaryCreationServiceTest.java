...
class SummaryCreationServiceTest {
   ...
   void testCreateRequestJson() {
      ...
      //when
      String apiRequestBody = _summaryCreationService.createOpenAIApiRequestBody(
            "You will have to pay your rent in 2 months or we will have to kick you out respectfully");

      //then
      assertThat(apiRequestBody).isNotBlank();
      ...
      assertThat(apiRequestBody).isEqualTo(expectedString);
   }
}
